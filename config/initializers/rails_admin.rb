# RailsAdmin config file. Generated on July 14, 2013 20:56
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Wherestibet', 'Admin']
  ...
  # config.excluded_models = ['Story']

  # Include specific models (exclude the others):
  # config.included_models = ['Story']
  ...
  #     configure :agreeTerms, :boolean 
  #     configure :narrative, :text 
